...
+ (void)testMsgSend {
    ...
    HWMsgSend *msg = ((HWMsgSend * (*)(id, SEL))objc_msgSend)((id)[HWMsgSend class], @selector(alloc));

    msg = ((HWMsgSend *(*)(id, SEL))objc_msgSend)((id)msg, @selector(init));
...
//    int d =  ((int (*)(id, SEL, NSString *, int))objc_msgSend)((id)msg, @selector(hasArguments:andReturnValue:), @"", 2012);
    ...
    //add method
    class_addMethod([HWMsgSend class], NSSelectorFromString(@"sayHello2"), (IMP)sayHello, "v@:");
    HWMsgSend *instance = [[HWMsgSend alloc] init];
